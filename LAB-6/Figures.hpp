...
public:
	...
	tPoint(int xSpeed, int ySpeed, int xCoordinate, int yCoordinate, int colorRed=245, int colorGreen=130, int colorBlue=57) : x_speed(xSpeed), y_speed(ySpeed),
...
public:
	Line() : thickness_1(80), thickness_2(3), rotation_degree(8) {
		cout << "Constructor Line\n";
	}
	Line(int thick1, int thick2, int rotation=0) : thickness_1(thick1), thickness_2(thick2), rotation_degree(rotation) {
		cout << "Constructor with params Line\n";
	}
	int get_x() {
		return x_coordinate;
	}
...
public:
	Rectangle() : length(30), height(80) {
		cout << "Constructor Rectangle\n";
	}
	Rectangle(int Length, int Height=60) : length(Length), height(Height) {
		cout << "Constructor with params Rectangle\n";
	}
	int get_x() {
		return x_coordinate;
	}
...
public:
	Triangle() : space(30), num_of_angles(3) {
		cout << "Constructor Triangle\n";
	}
	Triangle(int Space, int NumOfAngles=3) : space(Space), num_of_angles(NumOfAngles) {
		cout << "Constructor with params Triangle\n";
	}
	int get_x() {
		return x_coordinate;
	}
...
public:
	Ellipse() : radius(45), convexity(20) {
		cout << "Constructor Ellipse\n";
	}
	Ellipse(int Radius, int Convexity=40) : radius(Radius), convexity(Convexity) {
		cout << "Constructor with params Ellipse\n";
	}
	int get_x() {
		return x_coordinate;
	}
